      ...
      <div className="portfolio-details-info">
        <ul>
          ...
          <li>
            ...
            <span className="value">{e.sexualPreference}</span>
          </li>
          <li>
          ...
          <li>
            ...
            <span className="value">{`${e.language1} - ${e.level1}`}</span>
            {e.language2
              ? `<span className="value">${e.language2} - ${e.level2}</span>`
              : ""}
            {e.language3
              ? `<span className="value">${e.language3} - ${e.level3}</span>`
              : ""}
          </li>
