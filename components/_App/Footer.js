            ...
            <div className="col-lg-2 col-md-6 col-sm-6">
              <div className="single-footer-widget pl-2">
                ...
                <ul className="footer-links-list">
                  ...
                  <li>
                    <Link href="/escort-jobs">Employment
                    </Link>
                  </li>
                  <li>
                    <Link href="/faq">FAQ
                  ...
                  <li>
                    <Link href="/ettiquette">Ettiquette
                    </Link>
                  </li>
                  <li>
                    <Link href="/abbreviations">Abbreviations
                    </Link>
                  </li>
                </ul>
              </div>
